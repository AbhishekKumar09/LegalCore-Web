...
public class DAO {
	...
	public DAO() throws Exception {
		...
		c=DriverManager.getConnection("jdbc:mysql://localhost:3306/legalcoreweb","root","Abhishek@11");
	}
	...
	public String registerAdvocate(HashMap advocate) throws Exception {
		PreparedStatement p=c.prepareStatement("insert into advocates (email,name,phone,address,photo,experience,password,category) values (?,?,?,?,?,?,?,?)");
